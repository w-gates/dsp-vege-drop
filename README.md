...
This mod will cause vegetaion, rocks, etc to dropped loot as if mined whenever they are destroyed (by placing buldings, foundations, etc..). Items are dropped as litter if inventory is full. Hand mining drops extra items vs when the vege are destroyed.
